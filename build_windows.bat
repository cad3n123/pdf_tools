...
REM --- Writing PowerShell script line-by-line (Safe Mode) ---
...
echo ^</body^> >> "%PWS%"
echo ^</html^> >> "%PWS%"
REM --- FIX: Added Caret before Pipe below ---
